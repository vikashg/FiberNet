...
network = regression(network, optimizaer = 'adam', learning_rate = 0.0001, loss='categorical_crossentropy', name='target')
...
mode_name = out_dir + 'CNN_conv2d_32_conv2d_64_fc_128_fc_256_epoch_' + str(num_epoch) + '.tflearn'
