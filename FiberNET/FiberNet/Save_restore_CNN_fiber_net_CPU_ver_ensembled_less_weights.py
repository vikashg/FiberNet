...
out_dir = base_dir + 'CNN_model_less_w_num_epochs_' + str(num_epochs)  + '/CPU/' + fiber_grp + '/Model_' + str(model_num) + '/'

TensorBoard_dir = base_dir + 'CNN_model_less_w_num_epochs_' + str(num_epochs) + '/CPU/TensorBoard_dir/'+ fiber_grp  +'/Model_' + str(model_num) +'/'
