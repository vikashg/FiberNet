...
out_dir = base_dir + 'CNN_model_num_epochs_' + str(num_epochs) + '/CPU/Usual/' + fiber_grp + '/Model_' + str(model_num) + '/'

TensorBoard_dir = base_dir + 'CNN_model_num_epochs_' + str(num_epochs) + '/CPU/Usual/TensorBoard_dir/'+ fiber_grp  +'/Model_' + str(model_num) +'/'
...
model_name = out_dir + 'CNN_conv2d_32_conv2d_64_fc_128_fc_256_epoch_' + str(num_epochs) + '.tflearn'
