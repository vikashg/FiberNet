...
out_dir = base_dir + 'CNN_model_least_w/CPU/' + fiber_grp + '/Model_' + str(model_num) + '/'

TensorBoard_dir = base_dir + 'CNN_model_least_w/CPU/TensorBoard_dir/'+ fiber_grp  +'/Model_' + str(model_num) +'/'
...
network = conv_2d(network, 4, 3, activation = 'relu', regularizer ='L2')
